<script lang="ts">
	...
	import ProjectLinkItem from '../components/ProjectLinkItem.svelte';

	import Work from '../components/Work.svelte';
</script>

<p class="eyebrow">Hi there! I'm</p>
<h1>Darius Cepulis.</h1>
...
<ShortMediumLong defaultLength="medium">
	...
	<svelte:fragment slot="medium">
		...
		<p>
			...
			<a href="https://www.microsensorlabs.com/">Microsensor Labs</a>, where I use web technologies
			and good design to help healthcare providers wash their hands better.
		</p>
	</svelte:fragment>
	<svelte:fragment slot="long">
		...
		<p>
			Since then, I've built up my skills to match the needs of the modern monstrous monoliths that
			are web apps. And I love working on it all, up and down the stack: optimizing databases and
			plugging vulnerabilities on our back-end, ensuring reliability with rock-solid tests and
...
<Work>
	<svelte:fragment slot="header">
		<h3>
			Full-Stack Web Developer and UI/UX Nut <span class="employer">at Microsensor Labs</span>
		</h3>
	</svelte:fragment>
	...
	<ul>
		<li>
			Worked closely with hardware team and stakeholders to design, develop, and deploy a full-stack
			data analysis and visualization application for improving hygiene compliance in hospitals,
			currently used by dozens of users in a clinical trial setting.
		</li>
		<li>
			Provided input across hardware and software to ensure simple and coherent user interactions
			and experiences
		</li>
		<li>
			Developed marketing materials and web sites while establishing and maintaining our corporate
			visual identity
		</li>
	</ul>
</Work>
<Work>
	<svelte:fragment slot="header">
		<h3>
			Corporate Research Co-Op <span class="employer">at Bosch</span>
		</h3>
	</svelte:fragment>
	<svelte:fragment slot="location">
		<p>Renningen, Germany</p>
	</svelte:fragment>
	<svelte:fragment slot="duration">
		<p>January &ndash; August 2017</p>
	</svelte:fragment>
	<ul>
		<li>
			Designed and developed web app suite for large-scale, intuitive sensor data aggregation and
			analysis
		</li>
		<li>Lived and worked in a diverse, multilingual, international environment</li>
	</ul>
</Work>
<Work>
	<svelte:fragment slot="header">
		<h3>
			Innovation Lab Co-Op <span class="employer">at BMW Manufacturing</span>
		</h3>
	</svelte:fragment>
	<svelte:fragment slot="location">
	...
	<svelte:fragment slot="duration">
		<p>January &ndash; December 2015</p>
	</svelte:fragment>
	<ul>
		<li>
			Worked closely with stakeholders to design, develop, and deploy an iOS app for automobile
			inspections saving them 1+ hours a day
		</li>
		<li>Assisted Deep Learning research efforts by benchmarking clusters and preparing datasets</li>
		<li>Designed &amp; built Raspberry Pi robot for exploring 3D imaging techniques</li>
		<li>Lived and worked in a diverse, multilingual, international environment</li>
	</ul>
</Work>
...
<Project>
	...
	<p>
		...
		comprehensive data visualizations to managers and supervisors so that they can discover trends
		and take action. At the same time, it gamifies hygiene for individual providers with friendly
		competition, engaging interactions and animations, and a rewards system.
	</p>
...
<Project>
	...
	<p>
		...
		also a lightweight <a href="https://jamstack.wtf">JAMStack</a> blog and jobs listing built on Netlify
		and Gatsby.
	</p>
	<svelte:fragment slot="technologies">
		<li>React (Gatsby)</li>
...
<Project>
	...
	<p>
		...
		finally write that tribute to the
		<a href="http://www.firewatchgame.com">Firewatch parallax effect</a>
...
<Project>
	...
	<p>
		...
		for a long time. Some cell phone location data, a Raspberry Pi or Arduino, a bit of clockwork, and
		you've got something that seems like magic.
	</p>
	<svelte:fragment slot="technologies">
...
<Project>
	...
	<p>A crazy-minimal marketing website designed and built for a buddy's budding beer business.</p>
	<svelte:fragment slot="technologies">
		<li>Pug</li>
		<li>Parcel</li>
	</svelte:fragment>
	<svelte:fragment slot="links">
		...
		<ProjectLinkItem iconType="github" href="https://github.com/decepulis/midwest-microbio-site" />
	</svelte:fragment>
</Project>
<Project>
	<svelte:fragment slot="header">Formula Fun</svelte:fragment>
	<p>
		Some friends started up a betting pool for the 2021 season of Formula One. "Buy" four drivers
		and win points based on how they do. I wondered if I could beat the game with some
		statistics&hellip;
	</p>
	<svelte:fragment slot="technologies">
		<li>Svelte (TypeScript)</li>
	...
	<svelte:fragment slot="links">
		...
		<ProjectLinkItem iconType="github" href="https://github.com/decepulis/formula-fun" />
	</svelte:fragment>
</Project>
<section>
	<h4>More</h4>
...
<ul>
	<li>
		<IconLink title="Email" href="mailto:hello@decepulis.com">
			<MailIcon size="1x" />
		</IconLink>
	</li>
	<li>
		<IconLink title="GitHub" href="https://github.com/decepulis">
			<GithubIcon size="1x" />
		</IconLink>
	</li>
	<li>
		<IconLink title="LinkedIn" href="https://www.linkedin.com/in/decepulis/">
			<LinkedinIcon size="1x" />
		</IconLink>
	</li>
	<li>
		<IconLink title="Instagram" href="https://www.instagram.com/__dardarbinks/">
...
<dl>
	...
	<dt>Substantial Structural Inspiration</dt>
	<dd>
